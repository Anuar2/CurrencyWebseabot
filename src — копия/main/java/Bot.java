...
public class Bot  extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (message != null && message.hasText()) {
            ...
            if (message.getText().equals("/start")) {
                ...
                try {
                    sendSticker(message,"CAACAgIAAxkBAAEC0zJhKzp9-bem5qEOc8Vx0VtWthncYwACTwADrWW8FGuRHI2HrK-TIAQ");
                } catch (TelegramApiException e) {
                    e.printStackTrace();
                }
            ...
            /* First Menu */
                ...
                sendMsg(message, "Нажмите что угодно :3", 1);
                try {
                    sendSticker(message, "CAACAgIAAxkBAAEC0zBhKznyw2mNOPeMecV-4YCo78B7uwACCQAD8_KOPz0BzHWuifzlIAQ");
                } catch (TelegramApiException e) {
                    e.printStackTrace();
                }
            }
                ...
                sendMsg(message, "Orazbekov Anuar +77471703307", 1);
            }
    ...
    public String getBotToken() {
        return "462304129:AAEKmabk3dSDVRumi5hfBmY383wf1H9e_ks";
    }
}
